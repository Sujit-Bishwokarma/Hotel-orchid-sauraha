                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 bg-stone-900/40 p-4 border border-stone-800 rounded-sm space-y-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          <label className="block text-stone-400 text-[10px] font-mono uppercase mb-1">TripAdvisor URL</label>
                          <input 
                            type="text"
                            value={ownerInfo.tripadvisorUrl || ''}
                            onChange={(e) => updateOwnerInfo({ tripadvisorUrl: e.target.value })}
                            placeholder="https://tripadvisor.com/Hotel_Review-d123456"
                            className="w-full bg-stone-900 border border-stone-750 p-2 text-xs text-stone-100 rounded-sm focus:outline-none focus:border-coral-500 font-sans"
                          />
                        </div>

                        <div>
                          <label className="block text-stone-400 text-[10px] font-mono uppercase mb-1">YouTube URL</label>
                          <input 
                            type="text"
                            value={ownerInfo.youtubeUrl || ''}
                            onChange={(e) => updateOwnerInfo({ youtubeUrl: e.target.value })}
                            placeholder="https://youtube.com/c/hotel_orchid"
                            className="w-full bg-stone-900 border border-stone-750 p-2 text-xs text-stone-100 rounded-sm focus:outline-none focus:border-coral-500 font-sans"
                          />
                        </div>
                      </div>
